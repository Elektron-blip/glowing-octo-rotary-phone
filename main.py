...
async def insert_alarms(username: str, alarm:str):
    ...
    try:
        cursor.execute("INSERT INTO alarms (username, alarms) VALUES (%s, %s) WHERE username = %s", (username, alarms, username))
        return {"state": "Success"}
    except:
        return {"state": "Failed"}
...
async def update_alarms(username: str, alarm:str):
    alarms : "list[str]" = alarm[1:-1].split(",")
    try:
        cursor.execute("UPDATE alarms SET alarms = %s WHERE username = %s", (alarms, username))
        return {"state": "Success"}
    except:
        return {"state": "Failed"}
...
@app.put("/medicines/insert?username={username}&medicines={medicine}&dose={dose}&time={time}&inventory={inventory}")
async def insert_medicines(username: str, medicine: str, dose: str, time: str, inventory: int):
    try:
        cursor.execute("INSERT INTO medicines (username, medicines, dose, time, inventory) VALUES (%s, %s, %s, %s, %s) WHERE username = %s", (username, medicine, dose, time, inventory, username))
        return {"state": "Success"}
    except:
        return {"state": "Failed"}

@app.patch("/medicines/update?username={username}&medicines={medicine}&dose={dose}&time={time}&inventory={inventory}")
async def update_medicines(username: str, medicine: str, dose: str, time: str, inventory: int):
    try:
        cursor.execute("UPDATE medicines SET medicines = %s, dose = %s, time = %s, inventory = %s WHERE username = %s", (medicine, dose, time, inventory, username))
        return {"state": "Success"}
    except:
        return {"state": "Failed"}
...
async def delete_medicines(username: str, medicine: str):
    try:
        cursor.execute("DELETE FROM medicines WHERE username = %s AND medicines = %s", (username, medicine))
        return {"state": "Success"}
    except:
        return {"state": "Failed"}
...
async def insert_emergency(username: str, number: str):
    try:
        cursor.execute("INSERT INTO emergency (username, number) VALUES (%s, %s) WHERE username = %s", (username, number, username))
        return {"state": "Success"}
    except:
        return {"state": "Failed"}
...
async def update_emergency(username: str, number: str):
    try:
        cursor.execute("UPDATE emergency SET number = %s WHERE username = %s", (number, username))
        return {"state": "Success"}
    except:
        return {"state": "Failed"}
...
async def insert_birthdays(username: str, data: str):
    try:
        cursor.execute("INSERT INTO birthdays (username, data) VALUES (%s, %s) WHERE username = %s", (username, data, username))
        return {"state": "Success"}
    except:
        return {"state": "Failed"}
...
async def update_birthdays(username: str, data: str):
    try:
        cursor.execute("UPDATE birthdays SET data = %s WHERE username = %s", (data, username))
        return {"state": "Success"}
    except:
        return {"state": "Failed"}
